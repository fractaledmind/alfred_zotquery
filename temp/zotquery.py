...
BUNDLER_DIR = "alfred.bundler-aries/assets/python"
DEPS = os.path.join(BASE_DIR, BUNDLER_DIR)
...
class ZotCache(object):
    ...
    def __init__(self, force, personal_only):
        ...
        self.wf_obj = Workflow(plist=PLIST,
                               libraries=[DEPS])
...
def main(wf_obj):
    ...
    argv = wf_obj.args
    #argv = ['--filter', 'kemp irony', 'general']
