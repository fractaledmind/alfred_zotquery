...
if not os.path.exists(alp.storage(join="paths.json")):
	...
	if os.path.exists(storage_path):
		...
		""".format(alp.local(join='_user-interactions.scpt'), default_path)
	...
	if os.path.exists(attach_path):	
		...
		""".format(alp.local(join='_user-interactions.scpt'))
